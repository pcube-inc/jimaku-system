...
| **出退勤連絡** | 職場に着いたとき・帰るときにボタンを押す。トラブル報告もここから |
| **スタッフ掲示板** | お知らせ・申し送り・トラブル報告・研修報告をスタッフ間で共有する |
...
## ④ スタッフ掲示板 ― お知らせ・申し送りをみんなで共有する

「スタッフ掲示板」をタップすると、以下の画面が開きます。

![スタッフ掲示板](./docs/screenshots/board.png)
...
> **緊急のトラブルは、掲示板ではなく「出退勤連絡」のトラブル報告か電話で連絡してください。**
